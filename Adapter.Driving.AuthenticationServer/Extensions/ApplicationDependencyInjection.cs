...
public static class ApplicationDependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        if (connectionStrings?.AuthenticationServerDBConnection == null)
            throw new InvalidOperationException(
                $"{nameof(connectionStrings.AuthenticationServerDBConnection)} is required.");

        services.AddDbContext<ApplicationDbContext>(options =>
            options.UseSqlServer(connectionStrings.AuthenticationServerDBConnection));
