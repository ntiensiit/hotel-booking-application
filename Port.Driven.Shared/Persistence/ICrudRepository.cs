...
public interface ICrudRepository<T, in TId> : IReadOnlyRepository<T, TId>, IWriteOnlyRepository<T, TId>
    where T : class, IEntity<TId>
    where TId : IEquatable<TId>
{
}

public partial interface IListCrudRepository<T, in TId> : ICrudRepository<T, TId>
    where T : class, IEntity<TId>
    where TId : IEquatable<TId>
{
    new IList<T> FindAll();
...
public partial interface IListCrudRepository<T, in TId>
{
